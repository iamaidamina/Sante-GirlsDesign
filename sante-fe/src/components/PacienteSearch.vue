<template>
    <div class="left-sidebar">
        ...
        <span style="text-align:center; margin:30px; font-size:30px">Buscar Paciente</span> 
       
    </div>
    <div class="content">
        <form id="FormularioSerchPs" v-on:submit.prevent="processPsSearch">
            <div class="form-group">
                <span>Busque el paciente</span><br><br>
...
<script>
    ...
    methods: {
        ...
        processPsSearch: function() {
            let url = "https://sane-hospital-vjoha.herokuapp.com/pacientes/" + this.ps.id;
            axios.get(url)
                .then((result) => {
                    //alert("Exito");
