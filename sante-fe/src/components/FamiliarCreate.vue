<template>
    <div class="left-sidebar">
        ...
        <span style="text-align:center; margin:30px; font-size:30px">Crear Familiar Paciente</span> 
    ...
    export default {
        ...
        methods: {
            ...
            processPsSignUp: function() {
                axios.post(
                        "https://sane-hospital-vjoha.herokuapp.com/familiares/",
                        {
